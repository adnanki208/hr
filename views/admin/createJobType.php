...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><?php echo _PutJobTypeInformation;?> </h2>
                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="add" data-parsley-validate>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo _JobType;?><span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="name" class="form-control col-md-7 col-xs-12" required="" data-parsley-error-message="<?php echo _Required;?>"   name="firstName" placeholder="Full time"  type="text">
                            </div>
                        </div>
